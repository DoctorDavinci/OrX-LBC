...
namespace OrXBDAc.spawn
{
    ...
    public class SpawnOrX_TacticalToys : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            flagURL = "OrX_icon";
            OrX_TacticalToys01 = _OrX_TacticalToys01 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys01.craft";

            var _OrX_TacticalToys02 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys02 = _OrX_TacticalToys02 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys02.craft";

            var _OrX_TacticalToys03 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys03 = _OrX_TacticalToys03 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys03.craft";

            var _OrX_TacticalToys04 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys04 = _OrX_TacticalToys04 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys04.craft";

            var _OrX_TacticalToys05 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys05 = _OrX_TacticalToys05 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys05.craft";

            var _OrX_TacticalToys06 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys06 = _OrX_TacticalToys06 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys06.craft";

            var _OrX_TacticalToys07 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys07 = _OrX_TacticalToys07 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys07.craft";

            var _OrX_TacticalToys08 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys08 = _OrX_TacticalToys08 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys08.craft";

            var _OrX_TacticalToys09 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys09 = _OrX_TacticalToys09 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys09.craft";

            var _OrX_TacticalToys10 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            OrX_TacticalToys10 = _OrX_TacticalToys10 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToys" + "\\OrXTacticalToys10.craft";
