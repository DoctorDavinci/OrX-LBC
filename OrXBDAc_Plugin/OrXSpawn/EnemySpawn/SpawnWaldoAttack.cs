...
namespace OrXBDAc.spawn
{
    ...
    public class SpawnWaldoAttack : MonoBehaviour
    {
        ...
        private void Awake()
        {
            var OrXBDAcPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_Waldo01 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo01.craft";
            OrX_Waldo02 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo02.craft";
            OrX_Waldo03 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo03.craft";
            OrX_Waldo04 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo04.craft";
            OrX_Waldo05 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo05.craft";
            OrX_Waldo06 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo06.craft";
            OrX_Waldo07 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo07.craft";
            OrX_Waldo08 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo08.craft";
            OrX_Waldo09 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo09.craft";
            OrX_Waldo10 = OrXBDAcPath + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\Waldo" + "\\OrXWaldo10.craft";
        ...
        public void CheckSpawnTimer()
        {
            if (sg01)
            {
                Debug.Log("[Spawn OrX Waldo Attack] Spawning Waldo Blue Balls ......");
                loadingCraft = false;
                timer = true;
                WaldoVesselName = "Blue Ball";
            ...
            else
            {
                if (sg02)
                {
                    Debug.Log("[Spawn OrX Waldo Attack] Spawning Waldo Killer Tomatoes ......");
                    loadingCraft = false;
                    timer = true;
                    WaldoVesselName = "Killer Tomato";
                    StartCoroutine(SpawnCraftRoutine(OrX_Waldo02));
                }
                else
                {
                    if (sg03)
                    {
                        ...
                        StartCoroutine(SpawnCraftRoutine(OrX_Waldo03));
                    }
                    else
                    {
                        if (sg04)
                        {
                            ...
                            StartCoroutine(SpawnCraftRoutine(OrX_Waldo04));
                        }
                        else
                        {
                            if (sg05)
