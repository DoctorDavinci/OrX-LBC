...
{
    public class ModuleOrXMissionHolo : PartModule
    {
        ...
        {
            spawning = true;
            SpawnOrX_MissionHC.instance.HoloCacheName = HoloCacheName;

            if (HoloCoord1)
            {
                HoloCoord1 = false;
                SpawnOrX_MissionHC.instance.craftFile = HoloCraft1;
                SpawnOrX_MissionHC.instance._lat = HoloCoord1lat;
                SpawnOrX_MissionHC.instance._lon = HoloCoord1lon;
                SpawnOrX_MissionHC.instance._alt = HoloCoord1alt;
                SpawnOrX_MissionHC.instance.holo = false;
                SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                StartCoroutine(Spawn());
            }
            else
            {
                ...
                {
                    HoloCoord2 = false;
                    SpawnOrX_MissionHC.instance.craftFile = HoloCraft2;
                    SpawnOrX_MissionHC.instance._lat = HoloCoord2lat;
                    SpawnOrX_MissionHC.instance._lon = HoloCoord2lon;
                    SpawnOrX_MissionHC.instance._alt = HoloCoord2alt;
                    SpawnOrX_MissionHC.instance.holo = false;
                    SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                    StartCoroutine(Spawn());
                }
                else
                {
                    ...
                    {
                        HoloCoord3 = false;
                        SpawnOrX_MissionHC.instance.craftFile = HoloCraft3;
                        SpawnOrX_MissionHC.instance._lat = HoloCoord3lat;
                        SpawnOrX_MissionHC.instance._lon = HoloCoord3lon;
                        SpawnOrX_MissionHC.instance._alt = HoloCoord3alt;
                        SpawnOrX_MissionHC.instance.holo = false;
                        SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                        StartCoroutine(Spawn());
                    }
                    else
                    {
                        ...
                        {
                            HoloCoord4 = false;
                            SpawnOrX_MissionHC.instance.craftFile = HoloCraft4;
                            SpawnOrX_MissionHC.instance._lat = HoloCoord4lat;
                            SpawnOrX_MissionHC.instance._lon = HoloCoord4lon;
                            SpawnOrX_MissionHC.instance._alt = HoloCoord4alt;
                            SpawnOrX_MissionHC.instance.holo = false;
                            SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                            StartCoroutine(Spawn());
                        }
                        else
                        {
                            ...
                            {
                                HoloCoord5 = false;
                                SpawnOrX_MissionHC.instance.craftFile = HoloCraft5;
                                SpawnOrX_MissionHC.instance._lat = HoloCoord5lat;
                                SpawnOrX_MissionHC.instance._lon = HoloCoord5lon;
                                SpawnOrX_MissionHC.instance._alt = HoloCoord5alt;
                                SpawnOrX_MissionHC.instance.holo = false;
                                SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                StartCoroutine(Spawn());
                            }
                            else
                            {
                                ...
                                {
                                    HoloCoord6 = false;
                                    SpawnOrX_MissionHC.instance.craftFile = HoloCraft6;
                                    SpawnOrX_MissionHC.instance._lat = HoloCoord6lat;
                                    SpawnOrX_MissionHC.instance._lon = HoloCoord6lon;
                                    SpawnOrX_MissionHC.instance._alt = HoloCoord6alt;
                                    SpawnOrX_MissionHC.instance.holo = false;
                                    SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                    StartCoroutine(Spawn());
                                }
                                else
                                {
                                    ...
                                    {
                                        HoloCoord7 = false;
                                        SpawnOrX_MissionHC.instance.craftFile = HoloCraft7;
                                        SpawnOrX_MissionHC.instance._lat = HoloCoord7lat;
                                        SpawnOrX_MissionHC.instance._lon = HoloCoord7lon;
                                        SpawnOrX_MissionHC.instance._alt = HoloCoord7alt;
                                        SpawnOrX_MissionHC.instance.holo = false;
                                        SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                        StartCoroutine(Spawn());
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            HoloCoord8 = false;
                                            SpawnOrX_MissionHC.instance.craftFile = HoloCraft8;
                                            SpawnOrX_MissionHC.instance._lat = HoloCoord8lat;
                                            SpawnOrX_MissionHC.instance._lon = HoloCoord8lon;
                                            SpawnOrX_MissionHC.instance._alt = HoloCoord8alt;
                                            SpawnOrX_MissionHC.instance.holo = false;
                                            SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                            StartCoroutine(Spawn());
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                HoloCoord9 = false;
                                                SpawnOrX_MissionHC.instance.craftFile = HoloCraft9;
                                                SpawnOrX_MissionHC.instance._lat = HoloCoord9lat;
                                                SpawnOrX_MissionHC.instance._lon = HoloCoord9lon;
                                                SpawnOrX_MissionHC.instance._alt = HoloCoord9alt;
                                                SpawnOrX_MissionHC.instance.holo = false;
                                                SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                                StartCoroutine(Spawn());
                                            }
                                            else
                                            {
                                                ...
                                                {
                                                    HoloCoord10 = false;
                                                    SpawnOrX_MissionHC.instance.craftFile = HoloCraft10;
                                                    SpawnOrX_MissionHC.instance._lat = HoloCoord10lat;
                                                    SpawnOrX_MissionHC.instance._lon = HoloCoord10lon;
                                                    SpawnOrX_MissionHC.instance._alt = HoloCoord10alt;
                                                    SpawnOrX_MissionHC.instance.holo = false;
                                                    SpawnOrX_MissionHC.instance.CheckSpawnTimer();
                                                }
                                                else
