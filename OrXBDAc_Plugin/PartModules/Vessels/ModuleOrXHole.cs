...
//         UI_Toggle(scene = UI_Scene.All, disabledText = "", enabledText = "")]
        ...
        public void CrewCheck()
        {
            ...
            average = (random * random2) / 4 * KerbinMissions.instance.level;
        ...
        public void EmptyRoutine()
        {
            ...
            while (v.MoveNext())
            {
                ...
                List<ModuleOrXBDAc>.Enumerator orx = v.Current.FindPartModulesImplementing<ModuleOrXBDAc>().GetEnumerator();
                while (orx.MoveNext())
                {
