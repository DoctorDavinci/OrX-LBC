...
namespace OrX.spawn
{
    ...
    public class WaldosIslandSetup : MonoBehaviour
    {
        public static WaldosIslandSetup instance;
        ...
        private void Awake()
        {
            ...
            Debug.Log("[Wlados Island Setup] craftURL: " + OrXMissileTurret);

            OrXCIWS = _hole + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\OrXCIWS.craft";
            Debug.Log("[Wlados Island Setup] craftURL: " + OrXCIWS);

            OrXTMTSNBN = _hole + "\\PluginData" + "\\VesselData" + "\\OrX" + "\\OrXTMTSNBN.craft";
            Debug.Log("[Wlados Island Setup] craftURL: " + OrXTMTSNBN);
