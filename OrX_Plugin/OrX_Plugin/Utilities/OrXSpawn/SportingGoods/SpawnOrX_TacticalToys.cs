...
namespace OrX.spawn
{
    ...
    public class SpawnOrX_TacticalToys : MonoBehaviour
    {
        ////////////////////////////
        private void Start()
        {
        ...
        /// /////////////////////////
        /// </summary>
        public static SpawnOrX_TacticalToys instance;
        ...
        private string TacticalToysName = string.Empty;

        private string OrX_TacticalToys01 = string.Empty;
        private string OrX_TacticalToys02 = string.Empty;
        private string OrX_TacticalToys03 = string.Empty;
        private string OrX_TacticalToys04 = string.Empty;
        private string OrX_TacticalToys05 = string.Empty;
        private string OrX_TacticalToys06 = string.Empty;
        private string OrX_TacticalToys07 = string.Empty;
        private string OrX_TacticalToys08 = string.Empty;
        private string OrX_TacticalToys09 = string.Empty;
        private string OrX_TacticalToys10 = string.Empty;
        ...
        private void Awake()
        {
            var _OrX_TacticalToys01 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys01 = _OrX_TacticalToys01 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys01.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys01);

            var _OrX_TacticalToys02 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys02 = _OrX_TacticalToys02 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys02.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys02);

            var _OrX_TacticalToys03 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys03 = _OrX_TacticalToys03 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys03.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys03);

            var _OrX_TacticalToys04 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys04 = _OrX_TacticalToys04 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys04.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys04);

            var _OrX_TacticalToys05 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys05 = _OrX_TacticalToys05 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys05.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys05);

            var _OrX_TacticalToys06 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys06 = _OrX_TacticalToys06 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys06.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys06);

            var _OrX_TacticalToys07 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys07 = _OrX_TacticalToys07 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys07.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys07);

            var _OrX_TacticalToys08 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys08 = _OrX_TacticalToys08 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys08.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys08);

            var _OrX_TacticalToys09 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys09 = _OrX_TacticalToys09 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys09.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys09);

            var _OrX_TacticalToys10 = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            flagURL = "OrX_icon";
            OrX_TacticalToys10 = _OrX_TacticalToys10 + "\\PluginData" + "\\VesselData" + "\\SportingGoodsDepartment" + "\\TacticalToySalt" + "\\OrXTacticalToys10.craft";
            Debug.Log("[Spawn OrX Tank] craftURL: " + OrX_TacticalToys10);
        ...
        public void CheckSpawnTimer()
        {
            if (sg01)
            {
                ...
                timer = true;
                TacticalToysName = "";
                StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys01));
            }
            else
            {
                if (sg02)
                {
                    ...
                    timer = true;
                    TacticalToysName = "";
                    StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys02));
                }
                else
                {
                    if (sg03)
                    {
                        ...
                        timer = true;
                        TacticalToysName = "";
                        StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys03));
                    }
                    else
                    {
                        if (sg04)
                        {
                            ...
                            timer = true;
                            TacticalToysName = "";
                            StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys04));
                        }
                        else
                        {
                            if (sg05)
                            {
                                ...
                                timer = true;
                                TacticalToysName = "";
                                StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys05));
                            }
                            else
                            {
                                if (sg06)
                                {
                                    ...
                                    timer = true;
                                    TacticalToysName = "";
                                    StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys06));
                                }
                                else
                                {
                                    if (sg07)
                                    {
                                        ...
                                        timer = true;
                                        TacticalToysName = "";
                                        StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys07));
                                    }
                                    else
                                    {
                                        if (sg08)
                                        {
                                            ...
                                            timer = true;
                                            TacticalToysName = "";
                                            StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys08));
                                        }
                                        else
                                        {
                                            if (sg09)
                                            {
                                                ...
                                                timer = true;
                                                TacticalToysName = "";
                                                StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys09));
                                            }
                                            else
                                            {
                                                if (sg10)
                                                {
                                                    ...
                                                    timer = true;
                                                    TacticalToysName = "";
                                                    StartCoroutine(SpawnCraftRoutine(OrX_TacticalToys10));
                                                }
                                            }
                                        }
                                    }
        ...
        private void SpawnVessel(LootBoxVesselData LootBoxVesselData, List<ProtoCrewMember> crewData = null)
        {
            ...
            if (!string.IsNullOrEmpty(LootBoxVesselData.craftURL))
            {
                ...
                {
                    LootBoxVesselData.name = TacticalToysName;
